...
public class DbConnection {
   ...
   private static DbConnection instance; //istanza statica della classe //sing stesso tipo classe

    //design pattern singleton
   public static synchronized DbConnection getInstance() { //sing stesso tipo classe
	   if(instance == null)
